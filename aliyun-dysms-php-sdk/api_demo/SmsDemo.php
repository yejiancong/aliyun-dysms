...
class SmsDemo
{
    ...
    public static function sendBatchSms()
    {
        ...
        $request->setPhoneNumberJson(json_encode(['1500000000', '1500000001'], JSON_UNESCAPED_UNICODE));

        // 必填:短信签名-支持不同的号码发送不同的短信签名
        $request->setSignNameJson(json_encode(['云通信', '云通信'], JSON_UNESCAPED_UNICODE));
        ...
        $request->setTemplateParamJson(json_encode([['code' => '123'], ['code' => '456']], JSON_UNESCAPED_UNICODE));
